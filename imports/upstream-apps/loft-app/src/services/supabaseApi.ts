...
const EDGE_FN_MAP: Record<string, string> = {
  ...
  get_or_create_personal_room: 'get-or-create-personal-room',
  get_personal_room_by_slug: 'get-personal-room-by-slug',
  get_personal_room_waitlist: 'get-personal-room-waitlist',
  request_personal_room_access: 'request-personal-room-access',
  approve_waitlist_entry: 'approve-waitlist-entry',
  reject_waitlist_entry: 'reject-waitlist-entry',
  update_guest_leave_status: 'update-guest-leave-status',
  clear_room_waitlist: 'clear-room-waitlist',
  check_guest_waitlist_status: 'check-guest-waitlist-status',
  ...
  submit_host_application: 'submit-host-application',
  review_host_application: 'review-host-application',
