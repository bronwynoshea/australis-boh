...
const ProductReleaseReportsPage: React.FC = () => {
  ...
  const isLoading = reportType === 'detailed' ? isLoadingOverview : isLoadingExecutive;
  const reportError = reportType === 'detailed' ? overviewError : executiveError;
  const currentReportData = reportType === 'detailed' ? reportData : executiveSummary;
  ...
  const reportSummaryText = useMemo(() => {
    ...
    const lines: string[] = [
      `Product Release Report - ${filters.report_window.replace(/(\d+)/, ' $1 ').toUpperCase()}`,
      ...
      <div className="flex-1 h-full p-4 sm:p-6 lg:px-8">
        <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_320px] gap-6 items-start h-full">
          ...
          <div className="min-h-0 min-w-0 flex flex-col">
            {/* Report Results */}
            {hasRunReport && !isLoading && reportType === 'detailed' && reportData && renderOverview()}

            {hasRunReport && !isLoading && reportType === 'executive' && executiveSummary && (
            ...
            {hasRunReport && isLoading && (
              <div className="flex items-center justify-center py-12">
                <div className="flex items-center gap-3 text-boh-text-sub-light dark:text-boh-text-sub">
                  ...
                  <span>Running {reportType === 'executive' ? 'Executive Summary' : 'Detailed Release Report'}...</span>
                </div>
              </div>
            )}
                  ...
                  <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs text-boh-text-sub-light dark:text-boh-text-sub">
                        Current quarter initiatives and releases
                      </p>
                    </button>
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs text-boh-text-sub-light dark:text-boh-text-sub">
                        Upcoming quarter planning and readiness
                      </p>
                    </button>
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs text-boh-text-sub-light dark:text-boh-text-sub">
                        Medium-term roadmap and delivery timeline
                      </p>
                    </button>
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs text-boh-text-sub-light dark:text-boh-text-sub">
                        Annual strategic overview and risk assessment
                      </p>
                    </button>
                  </div>
          ...
          <div className="hidden xl:block w-[320px] relative">
            <div className="sticky top-6 p-4 space-y-6">
              ...
              <div>
                <FilterDropdown
                  label="Report Type"
                  displayValue={reportType === 'detailed' ? 'Detailed Release Report' : 'Executive Summary'}
                  options={[
                    { value: 'executive', label: 'Executive Summary' },
                    { value: 'detailed', label: 'Detailed Release Report' },
                  ]}
...
export default ProductReleaseReportsPage;
