...
serve(async (req: Request) => {
  ...
  try {
    ...
    console.log('[get-personal-room-by-slug] Looking up profile with slug:', slug);
    ...
    console.log('[get-personal-room-by-slug] Profile lookup result:', { profile, profileError });

    if (profileError || !profile) {
      console.log('[get-personal-room-by-slug] Profile not found');
    ...
    // Get room details
    console.log('[get-personal-room-by-slug] Looking up room:', profile.personal_room_id);
