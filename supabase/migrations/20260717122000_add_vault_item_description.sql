-- Extend audited Vault item editing with a user-facing description.
begin;
...
revoke all on function public.boh_vault_update_item_details_v2(uuid,uuid,text,text,text,text,uuid,text,uuid,text,text) from public, anon, authenticated;
...
comment on function public.boh_vault_update_item_details_v2(uuid,uuid,text,text,text,text,uuid,text,uuid,text,text)
is 'Audited Vault item metadata edit including description; protected reference changes require no active connections.';
